...
Media: [`public/`](./assets/media/). Full setup guide (Windows + macOS) below.
...
| **Generating** | Window hiện, **chỉ particles** (không chrome/debug UI) — xem [demo-2](./assets/media/demo-2.png) |
